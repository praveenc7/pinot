...
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.BROKER_RESOURCE_VALIDATION_FREQUENCY_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_BROKER_RESOURCE_VALIDATION_FREQUENCY_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_MINION_INSTANCES_CLEANUP_TASK_FREQUENCY_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_MINION_INSTANCES_CLEANUP_TASK_MIN_OFFLINE_TIME_BEFORE_DELETION_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_OFFLINE_SEGMENT_INTERVAL_CHECKER_FREQUENCY_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_REALTIME_SEGMENT_RELOCATION_INITIAL_DELAY_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_REALTIME_SEGMENT_VALIDATION_FREQUENCY_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_RETENTION_MANAGER_FREQUENCY_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_SEGMENT_LEVEL_VALIDATION_INTERVAL_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_SEGMENT_RELOCATOR_FREQUENCY_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_STATUS_CHECKER_FREQUENCY_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_STATUS_CHECKER_WAIT_FOR_PUSH_TIME_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_TASK_MANAGER_FREQUENCY_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.DEPRECATED_TASK_METRICS_EMITTER_FREQUENCY_IN_SECONDS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.MINION_INSTANCES_CLEANUP_TASK_FREQUENCY_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.MINION_INSTANCES_CLEANUP_TASK_MIN_OFFLINE_TIME_BEFORE_DELETION_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.OFFLINE_SEGMENT_INTERVAL_CHECKER_FREQUENCY_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.REALTIME_SEGMENT_VALIDATION_FREQUENCY_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.RETENTION_MANAGER_FREQUENCY_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.SEGMENT_LEVEL_VALIDATION_INTERVAL_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.SEGMENT_RELOCATOR_BATCH_SIZE_PER_SERVER;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.SEGMENT_RELOCATOR_BEST_EFFORTS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.SEGMENT_RELOCATOR_BOOTSTRAP;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.SEGMENT_RELOCATOR_DOWNTIME;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.SEGMENT_RELOCATOR_FREQUENCY_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.SEGMENT_RELOCATOR_INCLUDE_CONSUMING;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.SEGMENT_RELOCATOR_MINIMIZE_DATA_MOVEMENT;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.SEGMENT_RELOCATOR_MIN_AVAILABLE_REPLICAS;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.SEGMENT_RELOCATOR_REASSIGN_INSTANCES;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.STATUS_CHECKER_FREQUENCY_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.STATUS_CHECKER_WAIT_FOR_PUSH_TIME_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.TASK_MANAGER_FREQUENCY_PERIOD;
import static org.apache.pinot.controller.ControllerConf.ControllerPeriodicTasksConf.TASK_METRICS_EMITTER_FREQUENCY_PERIOD;
