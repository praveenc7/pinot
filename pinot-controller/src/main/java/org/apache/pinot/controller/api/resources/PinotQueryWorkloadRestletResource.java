...
public class PinotQueryWorkloadRestletResource {
  ...
  public Response refreshWorkload(@QueryParam("resourceType") String resourceType,
    ...
    try {
      LOGGER.info("Received refresh request - resourceType: {}, names: {}, nodeType: {}", resourceType, resourceNames,
          nodeTypeStr);
      List<String> nameList = validateAndParseRefreshRequest(resourceType, resourceNames);
   ...
   */
  private List<String> validateAndParseRefreshRequest(String resourceType, String resourceNames) {
   ...
   */
  private Response refreshWorkloadsByTables(List<String> tableNames, @Nullable NodeConfig.Type nodeType) {
