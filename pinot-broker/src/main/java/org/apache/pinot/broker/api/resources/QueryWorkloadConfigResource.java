...
/**
 * REST API resource for managing query workload configurations on broker instances.
 * <p>
 ...
 *
 * <p>
 * The resource supports both single and batch workload updates, as well as delete operations.
 * All operations are applied to the broker's WorkloadBudgetManager instance.
 * </p>
 */
@Api(tags = "Workload", description = "Query workload configuration management for broker")
@Path("/")
